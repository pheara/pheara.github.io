...
b) Vergleichen Sie die Begriffe „Echo Chamber“ von Sunstein und „Filter-Bubble“ von Pariser. Arbeiten Sie die _Ähnlichkeiten/Gemeinsamkeiten_ heraus und falls vorhanden auch die _Unterschiede_.
...
<!-- electorate college was also intended for that purpose (however, hasn't ever voted against public choice afaic [ref?] and causes massive problems -.- compare bush vs gore and trump vs clinton)-->

<!-- TODO iroquis confederation & "US-constitution by and for wealthy elites"
ad proposed part of the original Bill of Rights for right to instruct their representative: "against republican ideal". ~ "why would the representatives meet" (however, compare to iroquis confederation where represenatives went back and forth between meeting each other and their "constituents" to broker decisions. they couldn't move between what they'd been authorized. also a process of deliberation, albeit a slower one.) i would also argue, that western indirect democracy too often makes decisions behind closed doors (keeping the reasons secret) or fails at communicating these (as is the case for a lot of EU work) → (possibility of)/(image of) abitrary, self-interest-driven decisions

(real?) direct democracy only seems feasible given modern communication technologies (vs "horse = max comm. speed" in ye olde times)
...
Im Zweifelsfall ist allerdings zu sagen, dass die Empfehlungen auf Amazon allerdings oft auch in sehr pragmatischem Sinne etwas fragwürdig sind, e.g. schlägt es _nach_ dem Kauf eines Staubsaugers eine Sammlung anderer Staubsauger vor, nach dem Kauf einer Kamera den Kauf weiterer Kameras, etc (vermutlich da es sich bei diesen um "verwandte Produkte" handelt).
